...
{
    //<summary>
    //Descripción breve de ClsRegTdoclng_testudines_taxa
    //<//summary>
    public class ClsReg_tdoclng_testudines_taxa
    {
        ...
        private String m_LTaxNamesVulgar = "";
        private String m_LTaxEtimology = "";
        private String m_LTaxNotes = "";
        #endregion SQLDEFINICION_VARIABLES
        //------------------------------

        //---------------------------------------------------
        public ClsReg_tdoclng_testudines_taxa()
        {
            FncSqlBuildCommands();
            FncClear();
        }
        ...
        public void FncSqlBuildCommands()
        {
            ...
            //-------------- COMANDO SELECT  ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "SELECT * FROM tdoclng_testudines_taxa  ";
            szSql += " WHERE ";
            szSql += "(DocId=@DocId )";
            ...
            szSql = "INSERT INTO tdoclng_testudines_taxa";
            szSql += "(";
            szSql += " DocId ";
            szSql += ", DocLngId ";
            szSql += ", LTaxNamesVulgar ";
            szSql += ", LTaxEtimology ";
            szSql += ", LTaxNotes ";
            szSql += " ) VALUES     (";
            szSql += " @DocId ";
            ...
            oSqlCmdInsert.Parameters.Add("@LTaxNamesVulgar", MySql.Data.MySqlClient.MySqlDbType.VarChar);
            oSqlCmdInsert.Parameters.Add("@LTaxEtimology", MySql.Data.MySqlClient.MySqlDbType.Text);
            oSqlCmdInsert.Parameters.Add("@LTaxNotes", MySql.Data.MySqlClient.MySqlDbType.Text);
            //----------------------------------------------------------------------
            //----------------------------------------------------------------------
            //-------------- COMANDO UPDATE ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "UPDATE tdoclng_testudines_taxa SET ";

            szSql += "LTaxNamesVulgar=@LTaxNamesVulgar ";
            szSql += ", LTaxEtimology=@LTaxEtimology ";
            szSql += ", LTaxNotes=@LTaxNotes ";
            szSql += " WHERE ";
            szSql += "(DocId=@DocId )";
            szSql += " AND (DocLngId=@DocLngId )";
            ...
            oSqlCmdUpdate.Parameters.Add("@LTaxNamesVulgar", MySql.Data.MySqlClient.MySqlDbType.VarChar);
            oSqlCmdUpdate.Parameters.Add("@LTaxEtimology", MySql.Data.MySqlClient.MySqlDbType.Text);
            oSqlCmdUpdate.Parameters.Add("@LTaxNotes", MySql.Data.MySqlClient.MySqlDbType.Text);
            //----------------------------------------------------------------------
            //----------------------------------------------------------------------
            //-------------- COMANDO DELETE  ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "DELETE FROM tdoclng_testudines_taxa  ";
            szSql += " WHERE ";
            szSql += "(DocId=@DocId )";
            szSql += " AND (DocLngId=@DocLngId )";
            ...
            szSql += ", DocLngId";
            szSql += " FROM tdoclng_testudines_taxa  ";
        ...
        private bool FncSqlUpdate()
        {
            ...
            oSqlCmdUpdate.Parameters["@LTaxNamesVulgar"].Value = m_LTaxNamesVulgar;
            oSqlCmdUpdate.Parameters["@LTaxEtimology"].Value = m_LTaxEtimology;
            oSqlCmdUpdate.Parameters["@LTaxNotes"].Value = m_LTaxNotes;
            //-----------------------------------------------------;
            //            ACTUALIZAR 
            //-------------------------------------------------------;
        ...
        private bool FncSqlInsert()
        {
            ...
            oSqlCmdInsert.Parameters["@LTaxNamesVulgar"].Value = m_LTaxNamesVulgar;
            oSqlCmdInsert.Parameters["@LTaxEtimology"].Value = m_LTaxEtimology;
            oSqlCmdInsert.Parameters["@LTaxNotes"].Value = m_LTaxNotes;
            try
            {
        ...
        public bool FncSqlFind(UInt64 DocId, String DocLngId)
        {
            ...
            try
            {
                ...
                if ((oDR.HasRows) && (oDR.Read()))
                {
                    ...
                    m_LTaxNamesVulgar = oDR["LTaxNamesVulgar"].ToString();
                    m_LTaxEtimology = oDR["LTaxEtimology"].ToString();
                    m_LTaxNotes = oDR["LTaxNotes"].ToString();
                } //Cierre de if 
                else
                {
                    _mErrorBoolean = true;
        ...
        public String LTaxNamesVulgar
        {
            set
            {
                m_LTaxNamesVulgar = value;
            }
            get { return m_LTaxNamesVulgar; }
        }

        //................................

        public String LTaxEtimology
        {
            set
            {
                m_LTaxEtimology = value;
            }
            get { return m_LTaxEtimology; }
        }

        //................................

        public String LTaxNotes
        {
            set
            {
                m_LTaxNotes = value;
            }
            get { return m_LTaxNotes; }
        }
