...
{
    //<summary>
    //Descripción breve de ClsReg_tdoclng_testudines_desc_all
    //<//summary>
    public class ClsReg_tdoclng_testudines_desc_all
    {
        ...
        private Int32 m_ADesMeasureWeightGrm = 0;
        private Int32 m_ADesMeasureWeightGrmMax = 0;
        private Int32 m_ADesMeasureLenghtCm = 0;
        private Int32 m_ADesMeasureLenghtCmMax = 0;
        #endregion SQLDEFINICION_VARIABLES
        //------------------------------
        //---------------------------------------------------
        public ClsReg_tdoclng_testudines_desc_all()
        {
            FncSqlBuildCommands();
            FncClear();
        }
        ...
        {
            m_DocId = 0;
            m_ADesMeasureWeightGrm = 0;
            m_ADesMeasureWeightGrmMax = 0;
            m_ADesMeasureLenghtCm = 0;
            m_ADesMeasureLenghtCmMax = 0;
        }
        #endregion CLEAR
        //------------------------------
        //--------------------------------------------------------
        ...
        public void FncSqlBuildCommands()
        {
            ...
            //-------------- COMANDO SELECT  ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "SELECT * FROM tdoclng_testudines_desc_all  ";
            szSql += " WHERE ";
            szSql += "(DocId=@DocId )";
            ...
            szSql = "INSERT INTO tdoclng_testudines_desc_all";
            szSql += "(";
            szSql += " DocId ";
            szSql += ", ADesMeasureWeightGrm ";
            szSql += ", ADesMeasureWeightGrmMax ";
            szSql += ", ADesMeasureLenghtCm ";
            szSql += ", ADesMeasureLenghtCmMax ";
            szSql += " ) VALUES     (";
            szSql += " @DocId ";
            szSql += ", @ADesMeasureWeightGrm ";
            szSql += ", @ADesMeasureWeightGrmMax ";
            ...
            oSqlCmdInsert.Parameters.Add("@ADesMeasureWeightGrm", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdInsert.Parameters.Add("@ADesMeasureWeightGrmMax", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdInsert.Parameters.Add("@ADesMeasureLenghtCm", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdInsert.Parameters.Add("@ADesMeasureLenghtCmMax", MySql.Data.MySqlClient.MySqlDbType.Int32);
            //----------------------------------------------------------------------
            //----------------------------------------------------------------------
            //-------------- COMANDO UPDATE ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "UPDATE tdoclng_testudines_desc_all SET ";

            szSql += "ADesMeasureWeightGrm=@ADesMeasureWeightGrm ";
            szSql += ", ADesMeasureWeightGrmMax=@ADesMeasureWeightGrmMax ";
            szSql += ", ADesMeasureLenghtCm=@ADesMeasureLenghtCm ";
            szSql += ", ADesMeasureLenghtCmMax=@ADesMeasureLenghtCmMax ";
            szSql += " WHERE ";
            szSql += "(DocId=@DocId )";
            ...
            oSqlCmdUpdate.Parameters.Add("@ADesMeasureWeightGrm", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdUpdate.Parameters.Add("@ADesMeasureWeightGrmMax", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdUpdate.Parameters.Add("@ADesMeasureLenghtCm", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdUpdate.Parameters.Add("@ADesMeasureLenghtCmMax", MySql.Data.MySqlClient.MySqlDbType.Int32);
            //----------------------------------------------------------------------
            //----------------------------------------------------------------------
            //-------------- COMANDO DELETE  ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "DELETE FROM tdoclng_testudines_desc_all  ";
            szSql += " WHERE ";
            szSql += "(DocId=@DocId )";
            ...
            szSql = "SELECT ";
            szSql += " DocId";
            szSql += " FROM tdoclng_testudines_desc_all  ";
        ...
        private bool FncSqlUpdate()
        {
            ...
            oSqlCmdUpdate.Parameters["@ADesMeasureWeightGrm"].Value = m_ADesMeasureWeightGrm;
            oSqlCmdUpdate.Parameters["@ADesMeasureWeightGrmMax"].Value = m_ADesMeasureWeightGrmMax;
            oSqlCmdUpdate.Parameters["@ADesMeasureLenghtCm"].Value = m_ADesMeasureLenghtCm;
            oSqlCmdUpdate.Parameters["@ADesMeasureLenghtCmMax"].Value = m_ADesMeasureLenghtCmMax;
            //-----------------------------------------------------;
            //            ACTUALIZAR 
            //-------------------------------------------------------;
        ...
        private bool FncSqlInsert()
        {
            ...
            oSqlCmdInsert.Parameters["@ADesMeasureWeightGrm"].Value = m_ADesMeasureWeightGrm;
            oSqlCmdInsert.Parameters["@ADesMeasureWeightGrmMax"].Value = m_ADesMeasureWeightGrmMax;
            oSqlCmdInsert.Parameters["@ADesMeasureLenghtCm"].Value = m_ADesMeasureLenghtCm;
            oSqlCmdInsert.Parameters["@ADesMeasureLenghtCmMax"].Value = m_ADesMeasureLenghtCmMax;
            try
            {
        ...
        public bool FncSqlFind(UInt64 DocId)
        {
            ...
            try
            {
                ...
                if ((oDR.HasRows) && (oDR.Read()))
                {
                    ...
                    m_ADesMeasureWeightGrm = Convert.ToInt32(oDR["ADesMeasureWeightGrm"].ToString());
                    m_ADesMeasureWeightGrmMax = Convert.ToInt32(oDR["ADesMeasureWeightGrmMax"].ToString());
                    m_ADesMeasureLenghtCm = Convert.ToInt32(oDR["ADesMeasureLenghtCm"].ToString());
                    m_ADesMeasureLenghtCmMax = Convert.ToInt32(oDR["ADesMeasureLenghtCmMax"].ToString());
                } //Cierre de if 
                else
                {
                    _mErrorBoolean = true;
        ...
        public Int32 ADesMeasureWeightGrm
        {
            set
            {
                m_ADesMeasureWeightGrm = value;
            }
            get { return m_ADesMeasureWeightGrm; }
        }

        //................................

        public Int32 ADesMeasureWeightGrmMax
        {
            set
            {
                m_ADesMeasureWeightGrmMax = value;
            }
            get { return m_ADesMeasureWeightGrmMax; }
        }

        //................................

        public Int32 ADesMeasureLenghtCm
        {
            set
            {
                m_ADesMeasureLenghtCm = value;
            }
            get { return m_ADesMeasureLenghtCm; }
        }

        //................................

        public Int32 ADesMeasureLenghtCmMax
        {
            set
            {
                m_ADesMeasureLenghtCmMax = value;
            }
            get { return m_ADesMeasureLenghtCmMax; }
        }
