...
{
    //<summary>
    //Descripción breve de ClsRegSynonym_links
    //<//summary>
    public class ClsRegSynonym_links
    {
        ...
        public void FncSqlBuildCommands()
        {
            ...
            //-------------- COMANDO SELECT  ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "SELECT * FROM synonym_links  ";
            szSql += " WHERE ";
            szSql += "(tsn=@tsn )";
            ...
            //-------------- COMANDO INSERT ----------------------------------------
            //----------------------------------------------------------------------
            szSql = "INSERT INTO synonym_links";
            ...
            oSqlCmdInsert.Parameters.Add("@tsn_accepted", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdInsert.Parameters.Add("@update_date", MySql.Data.MySqlClient.MySqlDbType.DateTime);
            //----------------------------------------------------------------------
            //----------------------------------------------------------------------
            //-------------- COMANDO UPDATE ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "UPDATE synonym_links SET ";

            szSql += "tsn_accepted=@tsn_accepted ";
            ...
            oSqlCmdUpdate.Parameters.Add("@tsn_accepted", MySql.Data.MySqlClient.MySqlDbType.Int32);
            oSqlCmdUpdate.Parameters.Add("@update_date", MySql.Data.MySqlClient.MySqlDbType.DateTime);
            //----------------------------------------------------------------------
            //----------------------------------------------------------------------
            //-------------- COMANDO DELETE  ---------------------------------------
            //----------------------------------------------------------------------
            szSql = "DELETE FROM synonym_links  ";
            szSql += " WHERE ";
            szSql += "(tsn=@tsn )";
        ...
        private bool FncSqlUpdate()
        {
            ...
            oSqlCmdUpdate.Parameters["@tsn_accepted"].Value = m_tsn_accepted;
        ...
        private bool FncSqlInsert()
        {
            ...
            oSqlCmdInsert.Parameters["@tsn_accepted"].Value = m_tsn_accepted;
        ...
        public bool FncSqlFind(int tsn)
        {
            ...
            try
            {
                ...
                if ((oDR.HasRows) && (oDR.Read()))
                {
                    ...
                    m_tsn_accepted = Convert.ToInt32(oDR["tsn_accepted"].ToString());
        ...
        public int tsn_accepted
        {
            set
            {
                m_tsn_accepted = value;
            }
            get { return m_tsn_accepted; }
        }
