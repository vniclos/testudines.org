<%@ Page Title="Registrar un inicio de sesión externo" Language="C#" MasterPageFile="~/Mpg_Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="testudines.Account.RegisterExternalLogin" Async="true" %>
