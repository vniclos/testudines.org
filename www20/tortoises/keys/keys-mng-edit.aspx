<%@ Page Title="" Language="C#" MasterPageFile="~/Mpg_Site_Edit.Master" AutoEventWireup="true" CodeBehind="keys-mng-edit.aspx.cs" Inherits="testudines.tortoises.keys.keys_mng_edit" %>
    ...
    <div class="row">
        <h1>Identification keys<span class="fld-boxId"> DocId= <asp:Literal ID ="scnDocId" runat="server" Text="0"></asp:Literal></span></h1>
            ...
            <div class="row">
                ...
                <asp:Button ID="scnBtnNext" runat="server" Text="Next" />
                <asp:Button ID="scnBtnPrevious" runat="server" Text="Previous" />
                <asp:Button ID="scnBtnGoto" runat="server" Text="Goto" />
                <asp:Button ID="scnBtnClose" runat="server" Text="Close" />
    ...
    <!-- -------------------------------------------------------- -->
            <ajaxToolkit:TabPanel ID="tbEdit" runat="server" HeaderText="<%$ Resources:Strings, Edit_Root %>">
                ...
                <ContentTemplate>
                   ...
                   <div class="row">
                            <div class="col-4">
                            <uc3:ctl_imgfld ID="scnImgHlpPath01" runat="server" ID_Parents="cphContent_tbContainer_tbEdit_"   ImageNoImageUrl="/a_img/noimage200px.png" /> 
                            </div>
                            <div class="col-4">
                                <uc3:ctl_imgfld ID="scnImgHlpPath02" runat="server" ID_Parents="cphContent_tbContainer_tbEdit_"   ImageNoImageUrl="/a_img/noimage200px.png" />
                            </div>
                            <div class="col-4">
                                <uc3:ctl_imgfld ID="scnImgHlpPath03" runat="server" ID_Parents="cphContent_tbContainer_tbEdit_"   ImageNoImageUrl="/a_img/noimage200px.png" />
