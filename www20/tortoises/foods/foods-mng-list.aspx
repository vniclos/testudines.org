<%@ Page Title="" Language="C#" MasterPageFile="~/Mpg_Site.Master" AutoEventWireup="true" CodeBehind="foods-mng-list.aspx.cs" Inherits="testudines.tortoises.foods.foods_mng_list" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContentHead" runat="server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
       <h2> <asp:Literal ID="scnTitlePage" runat ="server" Text="<%$ Resources:Strings,  mnTortoises_foods_foods_mng_list %>"></asp:Literal></h2>
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
           ...
           <br> <span> Order by</span>
            ...
            <asp:GridView ID="scnGridView" runat="server" AllowPaging="True"  AutoGenerateColumns="False" DataKeyNames="DocId, DocLngId"  PageSize="20" Width ="100%"  
                PagerSettings-Mode="NumericFirstLast" PagerSettings-Position="Bottom" PagerSettings-PageButtonCount="10"  PagerSettings-Visible="True"  
                pagination-CssClass="pagination" PagerStyle-HorizontalAlign="Center" PagerStyle-BorderStyle="None" 
                PagerStyle-BorderWidth="1" AlternatingRowStyle-BorderStyle="None" PagerStyle-CssClass="pagination-ys" GridLines="None" 
                AlternatingRowStyle-BackColor="#EEEEEE" BorderStyle="None" HeaderStyle-CssClass="hide" 
                OnPageIndexChanging="scnGridView_PageIndexChanging" RowStyle-VerticalAlign="Top" RowStyle-CssClass="td-row" CssClass="td-row">
               <Columns>
                    <asp:HyperLinkField DataNavigateUrlFields="DocId, DocLngId" DataNavigateUrlFormatString="/{1}/tortoises/foods/food-mng-edit/{0}"
                        Text="<img src='/a_img/a_site/ico16/ico-write.png' alt='Edit' border='0'>" HeaderText="View" ItemStyle-CssClass="td-top" />

                    <asp:HyperLinkField DataNavigateUrlFields="DocId, DocLngId" DataNavigateUrlFormatString="/{1}/tortoises/foods/food/{0}"
                    ...
                    <asp:BoundField DataField="DocId" HeaderText="Doc" SortExpression="Id" ReadOnly="True" ItemStyle-CssClass="td-top" />
                     ...
                     <asp:BoundField DataField="DocLngId" HeaderText="DocLngId" SortExpression="DocLngId" ReadOnly="True" ItemStyle-CssClass="td-top" />
