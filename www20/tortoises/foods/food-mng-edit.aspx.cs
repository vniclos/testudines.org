...
{
    public partial class food_mng_edit : cls.ClsPageBaseEdit
    {
        private string m_tableName = "tdoclng_foods";
        private String  m_MaskUrl = "foods/artice"; // para crear url friendly, despues agregra idioma y titulo y barras automaticamente
        private string m_DocTypeId = "food";
        private cls.bbdd.ClsReg_tdoclng_foods m_oReg_EN = new cls.bbdd.ClsReg_tdoclng_foods();
        private cls.bbdd.ClsReg_tdoclng_foods m_oReg_ES= new cls.bbdd.ClsReg_tdoclng_foods();
       ...
       // private cls.bbdd.ClsReg_tdoclng m_oRegLng_EN = new cls.bbdd.ClsReg_tdoclng();
        ...
        private void FncFillBreadCrumb() {
            ...
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb,"foods","/"+cls.ClsGlobal.LngIdThread+"/foods/foods-list/" );
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb, "food Edit", "");
            cls.ClsHtml.FncHtmlBreadcrumbEnd(ref szBreadCrumb);
            Mpg_BreadCrumb(ref szBreadCrumb);
        }
        private void FncFillHead()
        {
            Page.Title = Resources.Strings.Edit + Resources.Strings.Foods + m_oReg_ES.Title;
        }
        ...
        private void FncScreenFromReg() {
           ...
           // m_oRegLng_ES.FncSqlFind(m_DocId, "esn");
            ...
            cls.ClsUtils.FncDropDownList_FoodTypeFill(ref scnFilterfoodType, scn_oDdoc_edit.DocTypeGroup);
            cls.ClsUtils.FncDropDownList_FoodTypeSubFill(ref scnFilterfoodTypeSub, scn_oDdoc_edit.DocTypeGroupSub);
        ...
        private void FncScreenToRegXX()
        {
            ...
            scn_oDdoc_edit.DocTypeGroup = scnFilterfoodType.SelectedValue;
            scn_oDdoc_edit.DocTypeGroupSub = scnFilterfoodTypeSub.SelectedValue;
        ...
        private void FncScreenToRegES() {
            ...
            scn_oDocLng_edit_ES.DocLngMetaKeyWords = scnFilterfoodType.SelectedValue + ", " + scnFilterfoodTypeSub.SelectedValue;
        ...
        private void FncScreenToRegEN()
        {
            ...
            scn_oDocLng_edit_EN.DocLngMetaKeyWords = scnFilterfoodType.SelectedValue + ", " + scnFilterfoodTypeSub.SelectedValue;
        ...
        protected void scnBtnListMng_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/ES/foods/foods-mng-list");
        }

        protected void scnBtnList_Click(object sender, EventArgs e)
        {
            Response.Redirect("/es/foods/foods-list");
        }
        ...
        protected void scnBtnShowES_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/es/foods/food/" + uiDocId.ToString());
            }
            else
            {
        ...
        protected void scnBtnShowEN_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/en/foods/food/" + uiDocId.ToString());
            }
            else
            {
