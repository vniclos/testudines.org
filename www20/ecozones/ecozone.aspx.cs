...
{
    public partial class ecozone: cls.ClsPageBase
  
    {

        private cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers oEcozone = new cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers();
        ...
        private void FncFill()
        {
            ...
            m_DocId = DocId;
            m_DocLngId = DocLngId;
            cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers oEcozone = new testudines.cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers();
        ...
        private void FncStadisticVisitAdd()
        {
            ...
            //oRegDoc.FncStdVisitAddCount("ecozone", oEcozone.DocLngId, Session.SessionID, System.Web.HttpContext.Current.User.Identity.ToString(), Request.UserHostAddress, szUrlReferrer, Request.Url.ToString(), "ecozone ", Request.UserAgent);
            //TODO verificar
            Page_FncStadisticVisitAdd(m_DocId, m_DocLngId, "");
        }
        private void FncFill(ref cls.bbdd.ClsReg_tdoc oDoc, ref cls.bbdd.ClsReg_tdoclng oDocLng, ref cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers oEcozone)
        {
            ...
            String BreadCrumb = oEcozone.FncHtmlBreadCrumb();
           Page_FncBreadCrumb(ref BreadCrumb);

        }

        private void FncFillPanelLeft(ref cls.bbdd.ClsReg_tdoc oDoc, ref cls.bbdd.ClsReg_tdoclng oDocLng, ref cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers oEcozone)
        {
        ...
        private void FncFillPanelRight(ref cls.bbdd.ClsReg_tdoc oDoc, ref cls.bbdd.ClsReg_tdoclng oDocLng, ref cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers oEcozone)
