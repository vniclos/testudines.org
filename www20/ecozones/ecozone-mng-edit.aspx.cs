...
{
    public partial class ecozone_mng_edit : cls.ClsPageBaseEdit
    {
        private string m_tableName = "tdoclng_geoclimate_koppengeigers";
        private String  m_MaskUrl = "ecozones/ecozone"; // para crear url friendly, despues agregra idioma y titulo y barras automaticamente
        private string m_DocTypeId = "ecozone";
        private cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers m_oReg_EN = new cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers();
        private cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers m_oReg_ES= new cls.bbdd.ClsReg_tdoclng_geoclimate_koppengeigers();
       ...
       // private cls.bbdd.ClsReg_tdoclng m_oRegLng_EN = new cls.bbdd.ClsReg_tdoclng();
        ...
        private void FncFillBreadCrumb() {
            ...
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb,"Ecozones","/"+cls.ClsGlobal.LngIdThread+"/ecozones/ecozones-list/" );
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb, "Ecozone Edit", "");
            cls.ClsHtml.FncHtmlBreadcrumbEnd(ref szBreadCrumb);
            Mpg_BreadCrumb(ref szBreadCrumb);
        }
        private void FncFillHead()
        {
            Page.Title = Resources.Strings.Edit + Resources.Strings.Ecozone + m_oReg_ES.Title;
        }
        ...
        private void FncScreenFromReg() {
           ...
           // m_oRegLng_ES.FncSqlFind(m_DocId, "esn");
            ...
            cls.ClsUtils.FncDropDownList_EcozoneTypeFill(ref scnFilterEcozoneType, scn_oDdoc_edit.DocTypeGroup);
            cls.ClsUtils.FncDropDownList_EcozoneTypeSubFill(ref scnFilterEcozoneTypeSub, scn_oDdoc_edit.DocTypeGroupSub);
        ...
        private bool FncScreenValidateEN()
        {
            ...
            {
                szError += "<br>Absract demasiado corto (80)";
                bOk = false;
            }
            if (scnAbstract_EN.Text.Length < 100)
            {
                szError += "<br>Absract demasiado corto (300)";
                bOk = false;
            }
        ...
        private void FncScreenToRegXX()
        {
            ...
            scn_oDdoc_edit.DocTypeGroup = scnFilterEcozoneType.SelectedValue;
            scn_oDdoc_edit.DocTypeGroupSub = scnFilterEcozoneTypeSub.SelectedValue;
        ...
        private void FncScreenToRegES() {
            ...
            scn_oDocLng_edit_ES.DocLngMetaKeyWords = scnFilterEcozoneType.SelectedValue + ", " + scnFilterEcozoneTypeSub.SelectedValue;
        ...
        private void FncScreenToRegEN()
        {
            ...
            scn_oDocLng_edit_EN.DocLngMetaKeyWords = scnFilterEcozoneType.SelectedValue + ", " + scnFilterEcozoneTypeSub.SelectedValue;
        ...
        protected void scnBtnListMng_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/ES/ecozones/ecozones-mng-list");
        }

        protected void scnBtnList_Click(object sender, EventArgs e)
        {
            Response.Redirect("/es/ecozones/ecozones-list");
        }
        ...
        protected void scnBtnShowES_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/es/ecozones/ecozone/" + uiDocId.ToString());
            }
            else
            {
        ...
        protected void scnBtnShowEN_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/en/ecozones/ecozone/" + uiDocId.ToString());
            }
            else
            {
