<%@ page title="" language="C#" masterpagefile="~/Mpg_Site_Edit.Master" autoeventwireup="true" codebehind="ecozone-mng-edit.aspx.cs" inherits="testudines.others.ecozones.ecozone_mng_edit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterEcozoneTypeTit" runat="server" CssClass="field-title-inline" Style="font-size: 9pt;" Text="<%$ Resources:Strings, EcozoneType %>"></asp:Label>
            <asp:DropDownList ID="scnFilterEcozoneType" runat="server">
            </asp:DropDownList>
        </div>
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterEcozoneTypeSubTit" runat="server" CssClass="field-title-inline" Text="<%$ Resources:Strings, EcozoneTypeSub %>"></asp:Label>
            <asp:DropDownList ID="scnFilterEcozoneTypeSub" runat="server">
            </asp:DropDownList>
        </div>
    </div>
                ...
                <div class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" id="document-3en">
                            <div class="form-group">
                                <asp:Label ID="scnBody_EN_tit" CssClass="fld-title-inline" for="scnBody_EN" runat="server" Text="Ecozone" ClientIDMode="Static"></asp:Label>
