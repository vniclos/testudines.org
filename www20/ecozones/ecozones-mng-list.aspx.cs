...
namespace testudines.ecozones
{
    public partial class ecozones_mng_list : cls.ClsPageBase
    {

        String m_Select= "select tdoclng_geoclimate_koppengeigers.DocId, tdoclng_geoclimate_koppengeigers.DocLngId,  concat( '/a_img/a_site/ico16/flag16_', doclngid,'.gif') as flag ,tdoclng_geoclimate_koppengeigers.Title, tdoclng_geoclimate_koppengeigers.Abstract,  tdoc.DocAcknowledgements, tdoc.DocAuthors,  DATE_FORMAT(tdoc.DocDateUpdate, '%Y-%m-%d') as 'update'  from tdoclng_geoclimate_koppengeigers LEFT join tdoc on tdoclng_geoclimate_koppengeigers.DocId = tdoc.DocId";
        String m_SelectWhere = " where title like '%#filter#%' or   tdoc.DocAcknowledgements like '%#filter#%' or tdoc.DocAuthors like '%#filter#%' or tdoclng_geoclimate_koppengeigers.Abstract like '%#filter#%' ";
        String m_SelectOrderUpdate = " order by  tdoc.DocDateUpdate desc";
        String m_SelectOrderTitle = " order by  tdoclng_geoclimate_koppengeigers.title";
        String m_filter = "";
        ...
        {
            Page_Title=(Resources.Strings.mnOthers_ecozones_mng_list);
        ...
        private void FncStadisticVisitAdd()
        {
            ...
            string szDocName = "ecozones_mng_list";
        ...
        private void FncFillBreadCrumb()
        {
            ...
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb, Resources.Strings.Ecozones, cls.ClsGlobal.LngIdThread + "/ecozones/");
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb, Resources.Strings.mnOthers_ecozones_mng_list, "");
