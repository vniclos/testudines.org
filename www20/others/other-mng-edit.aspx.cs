...
{
    public partial class other_mng_edit : cls.ClsPageBaseEdit
    {
        private string m_tableName = "tdoclng_others";
        private String  m_MaskUrl = "others/others/other"; // para crear url friendly, despues agregra idioma y titulo y barras automaticamente
        private string m_DocTypeId = "others-mng-edit";
        private cls.bbdd.ClsReg_tdoclng_others m_oReg_EN = new cls.bbdd.ClsReg_tdoclng_others();
        private cls.bbdd.ClsReg_tdoclng_others m_oReg_ES= new cls.bbdd.ClsReg_tdoclng_others();
       ...
       // private cls.bbdd.ClsReg_tdoclng m_oRegLng_EN = new cls.bbdd.ClsReg_tdoclng();
        ...
        private void FncFillBreadCrumb() {
            ...
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb,"others","/"+cls.ClsGlobal.LngIdThread+"/others/others-list/" );
            cls.ClsHtml.FncHtmlBreadcrumbAdd(ref szBreadCrumb, "other Edit", "");
            cls.ClsHtml.FncHtmlBreadcrumbEnd(ref szBreadCrumb);
            Mpg_BreadCrumb(ref szBreadCrumb);
        }
        private void FncFillHead()
        {
            Page.Title = Resources.Strings.Edit + Resources.Strings.other + m_oReg_ES.Title;
        }
        ...
        private void FncScreenFromReg() {
           ...
           // m_oRegLng_ES.FncSqlFind(m_DocId, "esn");
            ...
            cls.ClsUtils.FncDropDownList_OtherTypeFill(ref scnFilterotherType, scn_oDdoc_edit.DocTypeGroup);
            cls.ClsUtils.FncDropDownList_OtherTypeSubFill(ref scnFilterotherTypeSub, scn_oDdoc_edit.DocTypeGroupSub);
        ...
        private void FncScreenToRegXX()
        {
            ...
            scn_oDdoc_edit.DocTypeGroup = scnFilterotherType.SelectedValue;
            scn_oDdoc_edit.DocTypeGroupSub = scnFilterotherTypeSub.SelectedValue;
        ...
        private void FncScreenToRegES() {
            ...
            scn_oDocLng_edit_ES.DocLngMetaKeyWords = scnFilterotherType.SelectedValue + ", " + scnFilterotherTypeSub.SelectedValue;
        ...
        private void FncScreenToRegEN()
        {
            ...
            scn_oDocLng_edit_EN.DocLngMetaKeyWords = scnFilterotherType.SelectedValue + ", " + scnFilterotherTypeSub.SelectedValue;
        ...
        protected void scnBtnListMng_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/ES/others/others-mng-list");
        }

        protected void scnBtnList_Click(object sender, EventArgs e)
        {
            Response.Redirect("/es/others/others-list");
        }
        ...
        protected void scnBtnShowES_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/es/others/other/" + uiDocId.ToString());
            }
            else
            {
        ...
        protected void scnBtnShowEN_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/en/others/other/" + uiDocId.ToString());
            }
            else
            {
