<%@ page title="" language="C#" masterpagefile="~/Mpg_Site_Edit.Master" autoeventwireup="true" codebehind="other-mng-edit.aspx.cs" inherits="testudines.others.other_mng_edit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterotherTypeTit" runat="server" CssClass="field-title-inline" Style="font-size: 9pt;" Text="<%$ Resources:Strings, otherType %>"></asp:Label>
            <asp:DropDownList ID="scnFilterotherType" runat="server">
            </asp:DropDownList>
        </div>
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterotherTypeSubTit" runat="server" CssClass="field-title-inline" Text="<%$ Resources:Strings, otherTypeSub %>"></asp:Label>
            <asp:DropDownList ID="scnFilterotherTypeSub" runat="server">
            </asp:DropDownList>
        </div>
    </div>
                ...
                <div class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" id="document-3en">
                            <div class="form-group">
                                <asp:Label ID="scnBody_EN_tit" CssClass="fld-title-inline" for="scnBody_EN" runat="server" Text="other" ClientIDMode="Static"></asp:Label>
