<%@ page title="" language="C#" masterpagefile="~/Mpg_Site_Edit.Master" autoeventwireup="true" codebehind="notice-mng-edit.aspx.cs" inherits="testudines.notices.notice_mng_edit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterNoticeTypeTit" runat="server" CssClass="field-title-inline" Style="font-size: 9pt;" Text="<%$ Resources:Strings, NoticeType %>"></asp:Label>
            <asp:DropDownList ID="scnFilterNoticeType" runat="server">
            </asp:DropDownList>
        </div>
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterNoticeTypeSubTit" runat="server" CssClass="field-title-inline" Text="<%$ Resources:Strings, NoticeTypeSub %>"></asp:Label>
            <asp:DropDownList ID="scnFilterNoticeTypeSub" runat="server">
            </asp:DropDownList>
        </div>
    </div>
                ...
                <div class="form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" id="document-3en">
                            <div class="form-group">
                                <asp:Label ID="scnBody_EN_tit" CssClass="fld-title-inline" for="scnBody_EN" runat="server" Text="Notice" ClientIDMode="Static"></asp:Label>
