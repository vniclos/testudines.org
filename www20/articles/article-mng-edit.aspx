<%@ page title="" language="C#" masterpagefile="~/Mpg_Site_Edit.Master" autoeventwireup="true" codebehind="article-mng-edit.aspx.cs" inherits="testudines.articles.article_mng_edit" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterArticleTypeTit" runat="server" CssClass="field-title-inline" Style="font-size: 9pt;" Text="<%$ Resources:Strings, ArticleType %>"></asp:Label>
            <asp:DropDownList ID="scnFilterArticleType" runat="server">
            </asp:DropDownList>
        </div>
        <div class="col-6">
            <br />
            <asp:Label ID="scnFilterArticleTypeSubTit" runat="server" CssClass="field-title-inline" Text="<%$ Resources:Strings, ArticleTypeSub %>"></asp:Label>
            <asp:DropDownList ID="scnFilterArticleTypeSub" runat="server">
            </asp:DropDownList>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" id="document-1en">
                            ...
                            <asp:Button ID="scnBtnShowEN" class="btn btn-primary btn-sm" runat="server" Text="<%$ Resources:Strings, btn_show %>" OnClick="scnBtnShowEN_Click" />
                             <asp:Button ID="scnBtnDeleteEN" class="btn btn-primary btn-sm" runat="server" Text="<%$ Resources:Strings, Delete %>" onclick="scnBtnDeleteEN_Click" />
                            <ajaxToolkit:ConfirmButtonExtender ID="scnBtnDeleteEN_ConfirmButtonExtender" runat="server" BehaviorID="scnBtnDeleteEN_ConfirmButtonExtender" ConfirmText="Do you want delete EN" TargetControlID="scnBtnDeleteEN" />
