...
{
    public partial class article_mng_edit : cls.ClsPageBaseEdit
    {
        private string m_tableName = "tdoclng_articles";
        private String  m_MaskUrl = "articles/artice"; // para crear url friendly, despues agregra idioma y titulo y barras automaticamente
        private string m_DocTypeId = "article";
        private cls.bbdd.ClsReg_tdoclng_articles m_oReg_EN = new cls.bbdd.ClsReg_tdoclng_articles();
        private cls.bbdd.ClsReg_tdoclng_articles m_oReg_ES= new cls.bbdd.ClsReg_tdoclng_articles();
       ...
       // private cls.bbdd.ClsReg_tdoclng m_oRegLng_EN = new cls.bbdd.ClsReg_tdoclng();
        ...
        {
            Page.Title = Resources.Strings.Edit + Resources.Strings.Article + m_oReg_ES.Title;
        }
        ...
        private void FncScreenFromReg() {
           ...
           // m_oRegLng_ES.FncSqlFind(m_DocId, "esn");
            ...
            cls.ClsUtils.FncDropDownList_ArticleTypeFill(ref scnFilterArticleType, scn_oDdoc_edit.DocTypeGroup);
            cls.ClsUtils.FncDropDownList_ArticleTypeSubFill(ref scnFilterArticleTypeSub, scn_oDdoc_edit.DocTypeGroupSub);
        ...
        private void FncScreenToRegES() {
            ...
            scn_oDocLng_edit_ES.DocLngMetaKeyWords = scnFilterArticleType.SelectedValue + ", " + scnFilterArticleTypeSub.SelectedValue;
        ...
        private void FncScreenToRegEN()
        {
            ...
            scn_oDocLng_edit_EN.DocLngMetaKeyWords = scnFilterArticleType.SelectedValue + ", " + scnFilterArticleTypeSub.SelectedValue;
        ...
        protected void scnBtnListMng_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("/ES/articles/articles-mng-list");
        }

        protected void scnBtnList_Click(object sender, EventArgs e)
        {
            Response.Redirect("/es/articles/articles-list");
        }
        ...
        protected void scnBtnShowES_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/es/articles/article/" + uiDocId.ToString());
            }
            else
            {
        ...
        protected void scnBtnShowEN_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("/en/articles/article/" + uiDocId.ToString());
            }
            else
            {
        ...
        {
            m_oReg_ES.FncSqlDelete(Convert.ToUInt64(scnDocId.Text), "es");
            FncScreenToRegES();
        }

        protected void scnBtnDeleteEN_Click(object sender, EventArgs e)
        {
            m_oReg_EN.FncSqlDelete(Convert.ToUInt64(scnDocId.Text), "es");
            FncScreenToRegEN();
        }
    }
}